...
<template>
  <div class="flex justify-between items-center">
    ...
    <div class="flex-col md:flex gap-4">
      <select
        class="w-[150px] md:w-full py-2 px-3 border rounded-md outline-none"
        @change="onChangeSelect"
      >
        <option class="text-sm md:text-lg" value="name">
          По названию
        </option>
        <option class="text-sm md:text-lg" value="price">
          По цене (дешёвые)
        </option>
        <option class="text-sm md:text-lg" value="-price">
          По цене (дорогие)
      ...
      <div class="relative">
        ...
        <input
          class="w-[150px] md:w-full border rounded-md py-2 pl-12 pr-4 outline-none focus:border-gray-400"
          placeholder="Поиск..."
